...
SECRET_KEY = 'django-insecure-ynxwo)g3(xd7&_rww1n)*62hoy9&#qyo49d8b5#=4j6qj)2(_3'
...
TEMPLATE_DIR = os.path.join(CORE_DIR, "HomeAssistant/templates")  # ROOT dir for templates
...
STATICFILES_DIRS = (
    os.path.join(CORE_DIR, 'HomeAssistant/static'),
)
